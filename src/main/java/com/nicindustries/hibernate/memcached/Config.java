...
package com.nicindustries.hibernate.memcached;

import com.nicindustries.hibernate.memcached.keystrategy.KeyStrategy;
...
public class Config {
    ...
    private static final String DEFAULT_MEMCACHE_CLIENT_FACTORY = "com.nicindustries.hibernate.memcached.spymemcached.SpyMemcacheClientFactory";
